            ...
            steps {
                script {
                    ...
                    sshagent(['ec2-server-key']) {
                        sh "scp docker-compose.yml ubuntu@100.27.226.149:/home/ubuntu/"
                        sh "ssh -o StrictHostKeyChecking=no docker-compose.yml ubuntu@100.27.226.149 ${dockerComposeCmd}"
                    }
                }
            }
        }
